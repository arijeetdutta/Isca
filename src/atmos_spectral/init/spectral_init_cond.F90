...
logical :: smooth_input_land = .true. ! From Ruth Geen https://github.com/RuthG/Isca/blob/land_smooth/src/atmos_spectral/init/spectral_init_cond.F90
...
!  RG add lines to read land mask as well as topography, then convert to an ocean_mask for smoothing
  ...
  if(smooth_input_land) then ! From Ruth Geen https://github.com/RuthG/Isca/blob/land_smooth/src/atmos_spectral/init/spectral_init_cond.F90
